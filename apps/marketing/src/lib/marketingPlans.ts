...
export const marketingPlans: MarketingPlan[] = [
  {
    ...
    features: ['Private release catalog', 'One source connection', 'Shared review policy', 'pskills install path'],
  ...
  },
  {
    id: 'team',
    name: 'Team',
    audience: 'Several workflows, one team',
    price: 'Preview',
    cadence: 'packaging under review',
  ...
  },
  {
    id: 'organization',
    name: 'Organization',
    audience: 'Multiple teams under one organization',
    price: 'Preview',
    cadence: 'rollout planning',
    description: 'A planning conversation for teams sharing infrastructure across projects.',
    features: ['Shared team rollout', 'Policy and source planning', 'Rollout planning', 'Adoption guidance'],
    cta: 'Plan a rollout',
