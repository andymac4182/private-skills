  ...
  return <div className="marketing-start-layout">
      ...
      <section className="marketing-start-paths" aria-labelledby="getting-started-path-title">
        ...
        <div className="marketing-start-path-grid">
          <article className="marketing-start-path-card marketing-start-path-card-primary"><span className="marketing-feature-index">01 / APPLICATION WORKSPACE</span><h3>Open the application workspace</h3><p>If your team already has access, open application sign-in. The current hosted preview has no public account sign-up and its company sign-in is not configured, so use an existing registry token supplied by an owner or administrator. This marketing site does not create accounts or collect credentials.</p><div className="marketing-start-path-actions"><a className="marketing-button marketing-button-primary" href={appLoginHref()}>Open app sign-in <span aria-hidden="true">↗</span></a><a className="marketing-text-link" href="#cli">Jump to CLI setup <span aria-hidden="true">↓</span></a></div></article>
      ...
      <div className="marketing-start-content">
        <div className="marketing-start-steps">
          <section className="marketing-start-step" id="setup"><span className="marketing-start-step-number">01</span><div className="marketing-start-step-copy"><h2>Open the application workspace</h2><p>For an application workspace, start with the app sign-in above and use the access path supplied by your owner or administrator. The current hosted preview uses an existing registry token while company sign-in is not configured. For local operator work, use the separate disposable setup card; the two paths have different responsibilities and credentials.</p></div></section>
