  ...
  return <div className="marketing-docs-layout">
    <article className="marketing-docs-main">
      ...
      <div className="marketing-docs-cards">
        ...
        <a className="marketing-doc-card" href="/pricing"><span className="marketing-doc-card-index">04 / EVALUATE</span><h2>Plans and rollout</h2><p>Compare the pricing preview and decide which company team should run the first real workflow.</p><span>View pricing preview ↗</span></a>
      </div>
      <div className="marketing-docs-note"><strong>Current product status</strong><span>The public pages describe the implemented registry, pull-through, packs, and Eve features. Provider availability, scanner configuration, and deployment evidence still depend on the environment you choose.</span></div>
    </article>
