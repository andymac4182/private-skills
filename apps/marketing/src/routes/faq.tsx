...
function FaqPage() {
  return <PublicLayout current="faq">
    ...
    <section className="marketing-faq marketing-faq-page" aria-label="Frequently asked questions">
      ...
      <details><summary>What does first-time sign-in do?</summary><p>Use Sign in to registry when your configured app environment is enabled. The authenticated deployment determines its identity and workspace setup path; this marketing site does not create accounts. The current CLI path accepts a scoped token through <code>pskills login --registry &lt;registry-url&gt; --token-stdin</code>.</p></details>
