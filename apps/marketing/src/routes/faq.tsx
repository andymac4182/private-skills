...
function FaqPage() {
  return <PublicLayout current="faq">
    ...
    <section className="marketing-faq marketing-faq-page" aria-label="Frequently asked questions">
      ...
      <details><summary>Is the demo connected to a live registry?</summary><p>No. The <a href="/demo">demo walkthrough</a> uses clearly labelled example records and placeholder identifiers, so it can be presented before a live registry is connected. Use the getting started guide with your application workspace or local setup for a real evaluation.</p></details>
      ...
      <details><summary>Can I search an external catalog?</summary><p>With a connected source catalog, you can search through the registry. The source identity stays with the candidate, and discovery alone does not approve a release.</p></details>
      ...
      <details><summary>What does first-time sign-in do?</summary><p>If your team already has access, open the app sign-in link. The current hosted preview has no public account sign-up and its company sign-in is not configured, so use an existing registry token supplied by an owner or administrator. This marketing site does not create accounts. The current CLI path accepts a scoped token through <code>pskills login --registry &lt;registry-url&gt; --token-stdin</code>.</p></details>
      <details><summary>Is pricing available?</summary><p>The pricing page is a preview of plan limits while commercial packaging is being decided. No purchase or payment path is active.</p></details>
      <details><summary>How do I request a walkthrough?</summary><p>Open the <a href="/contact">contact page</a>. It shows a public request link when one has been published; otherwise it gives you the available guide, demo, and application sign-in paths.</p></details>
      <details><summary>Are the legal and privacy documents published?</summary><p>Not yet. The <a href="/legal#publication-status">legal and privacy status</a> page records the current site facts and preview status.</p></details>
    </section>
  </PublicLayout>
}
