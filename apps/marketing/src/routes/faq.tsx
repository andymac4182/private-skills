...
function FaqPage() {
  return <PublicLayout current="faq">
    ...
    <section className="marketing-faq marketing-faq-page" aria-label="Frequently asked questions">
      ...
      <details><summary>What does first-time sign-in do?</summary><p>If your team has an application workspace, open the app sign-in link. The application shows the sign-in and workspace steps for your team; this marketing site does not create accounts. The current CLI path accepts a scoped token through <code>pskills login --registry &lt;registry-url&gt; --token-stdin</code>.</p></details>
