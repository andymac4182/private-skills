  ...
  return <PublicLayout current="home">
    <section className="marketing-hero" aria-labelledby="marketing-hero-title">
      <div className="marketing-hero-copy">
        <span className="marketing-eyebrow">For engineering teams rolling out AI-agent skills</span>
        <h1 id="marketing-hero-title">Move from skill source to <em>repeatable install.</em></h1>
        <p className="marketing-hero-lede">Private Skills gives platform and developer-experience teams one place to inspect source identity, required checks, release decisions, and the version each project installs.</p>
        ...
        <p className="marketing-hero-note"><span aria-hidden="true" className="marketing-status-dot" />Private registry <span aria-hidden="true">·</span> source and policy visible <span aria-hidden="true">·</span> review gate when enabled</p>
      </div>
    ...
    <section className="marketing-section" id="product" aria-labelledby="product-title">
      ...
      <div className="marketing-feature-grid">
        ...
        <article className="marketing-feature-card"><span className="marketing-feature-index">02 / PULL-THROUGH</span><h3>Source pull-through</h3><p>For an enabled catalog, preserve its source identity and bring a candidate through required checks before it can be cached.</p><span className="marketing-feature-tag">provenance attached</span></article>
    ...
    <section className="marketing-section" aria-labelledby="faq-title">
      ...
      <div className="marketing-faq">
        ...
        <details><summary>Does every release need a human approval?</summary><p>Only when the configured policy adds a review gate. Required scanner evidence can drive a policy decision without a manual step; Eve's proposals are advisory unless that separate gate is enabled.</p></details>
