...
function LegalPage() {
  return <PublicLayout current="legal">
    ...
    <section className="marketing-legal-layout" aria-label="Legal and product notes">
      ...
      <article className="marketing-legal-card"><span className="marketing-feature-index">02 / APP ACCESS</span><h2>Where application access begins</h2><p>Use <a href={appLoginHref()}>Open app sign-in</a> if your team already has access. The current hosted preview has no public account sign-up and its company sign-in is not configured, so access uses an existing registry token supplied by an owner or administrator. This public site does not create accounts.</p></article>
