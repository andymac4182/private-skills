  ...
  return <PublicLayout current="legal">
    <section className="marketing-page-hero" aria-labelledby="legal-page-title">
      <div className="marketing-page-hero-grid">
        ...
        <div className="marketing-page-hero-note"><strong>Last reviewed: launch preview</strong>This page is part of the marketing deployment. App access, company setup, registry data, and any future billing terms belong to the authenticated app and its published terms.</div>
      </div>
    </section>
    <section className="marketing-legal-layout" aria-label="Legal and product notes">
      ...
      <article className="marketing-legal-card"><span className="marketing-feature-index">02 / APP ACCESS</span><h2>Where sign-in happens</h2><p>Use <a href={appLoginHref()}>Open registry</a> to continue to the authenticated app. Sign-in uses the configured identity provider; first-time users may continue to company setup before opening a registry.</p></article>
      <article className="marketing-legal-card"><span className="marketing-feature-index">03 / PRODUCT STATUS</span><h2>What the preview means</h2><p>Examples, screenshots, plan shapes, and feature descriptions on this site are provided for evaluation. Provider availability, scanner configuration, and deployment evidence depend on the selected environment.</p></article>
      ...
      <article className="marketing-legal-card"><span className="marketing-feature-index">06 / NEXT STEP</span><h2>Read the current guide</h2><p>For the product workflow and operational boundaries, read <a href="/docs/getting-started">getting started</a>. For the public answers, see the <a href="/faq">FAQ</a>.</p></article>
    </section>
  </PublicLayout>
}
