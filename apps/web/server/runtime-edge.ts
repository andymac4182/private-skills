...
export async function createInfrastructure(env: RuntimeEnvironment): Promise<{ repository: StateRepository; blobs: BlobStore; createSearchIndex: (profile: EmbeddingProfile) => SemanticIndex }> {
