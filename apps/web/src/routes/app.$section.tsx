...
import type { CliReleaseTarget } from '../../../../packages/cli-release/src/index.js'
...
function parseSearch(search: Record<string, unknown>): AppSectionSearch {
  ...
  const target = boundedString(search.target, 64)
  return {
    ...
    ...(target && CLI_RELEASE_TARGETS.has(target as CliReleaseTarget) ? { target: target as CliReleaseTarget } : {}),
  }
}
