...
export function BillingView({ fetcher = fetch }: BillingViewProps) {
  ...
  if (!data) return <div className="view-heading"><div className="page-intro"><div><span className="eyebrow">Company billing</span><h1>Billing &amp; usage</h1><p className="muted">Loading the server-owned plan, usage, and invoice state.</p></div></div><Panel><LoadingState label="Loading company billing…" /></Panel></div>
