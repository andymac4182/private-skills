...
export function DirectoryView() {
  ...
  const [detail, setDetail] = useState<SkillDetailMetadataResponse | null>(null)
...
function DirectoryDetailPanel({ detail, detailDisconnected, detailError, feed, feedsError, feedsLoading, loading, selected, onRetry }: { detail: SkillDetailMetadataResponse | null; detailDisconnected: boolean; detailError: string | null; feed: DirectoryFeed | null; feedsError: string | null; feedsLoading: boolean; loading: boolean; selected: V1Skill; onRetry: () => void }) {
