...
export function PolicyView() {
  ...
  const canManage = session?.activeMembership
    ? session.activeMembership.role === 'owner' || session.activeMembership.role === 'admin'
