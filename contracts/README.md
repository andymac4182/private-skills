...
These JSON Schemas use draft 2020-12. They make the planned payload shapes concrete; they do not implement a registry or cover the whole API. The first implementation milestone must freeze them alongside OpenAPI, generate Rust/TypeScript types, and add shared conformance vectors.
