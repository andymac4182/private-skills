...
| `docs/identity-company-sso.md` | Tenant identity contract, critical isolation surfaces, provider strategy, migration requirements, and focused acceptance plan. | A deployed Better Auth implementation until its tests and hosted readback pass. |
