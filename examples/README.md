# Illustrative v1 examples

No endpoint, package, hash, token, or scanner result here is live.

- [skill-pack.json](skill-pack.json): a pack draft containing private and proxied skills.
- [pskills.json](pskills.json): project intent, registry/namespace mapping, target, direct skills, and packs.
